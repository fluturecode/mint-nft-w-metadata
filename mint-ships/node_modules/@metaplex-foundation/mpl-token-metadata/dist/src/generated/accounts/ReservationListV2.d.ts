...
import { Reservation } from '@metaplex-foundation/mpl-token-metadata/dist/src/generated/types/Reservation';
...
export declare class ReservationListV2 implements ReservationListV2Args {
    ...
    static fromAccountAddress(connection: web3.Connection, address: web3.PublicKey, commitmentOrConfig?: web3.Commitment | web3.GetAccountInfoConfig): Promise<ReservationListV2>;
    static gpaBuilder(programId?: web3.PublicKey): beetSolana.GpaBuilder<ReservationListV2Args>;
