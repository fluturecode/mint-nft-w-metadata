...
import { TransferArgs } from '@metaplex-foundation/mpl-token-metadata/dist/src/generated/types/TransferArgs';
export type TransferInstructionArgs = {
    transferArgs: TransferArgs;
};
export declare const TransferStruct: beet.FixableBeetArgsStruct<TransferInstructionArgs & {
...
export declare const transferInstructionDiscriminator = 49;
