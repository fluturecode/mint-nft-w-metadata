...
import { Beet } from '@metaplex-foundation/mpl-candy-machine-core/node_modules/@metaplex-foundation/beet/dist/types/src/types';
/**
 ...
 * @category beet
 */
export declare function fixBeetFromData<T, V = Partial<T>>(beet: Beet<T, V>, buf: Buffer, offset: number): import("@metaplex-foundation/mpl-candy-machine-core/node_modules/@metaplex-foundation/beet/dist/types/src/types").ScalarFixedSizeBeet<T, V> | import("@metaplex-foundation/mpl-candy-machine-core/node_modules/@metaplex-foundation/beet/dist/types/src/types").ScalarFixedSizeBeet<T, Partial<T>>;
/**
 * Converts the provided beet into a {@link FixedBeet} unless it already is.
 ...
 * @category beet
 */
export declare function fixBeetFromValue<T, V = Partial<T>>(beet: Beet<T, V>, val: V): import("@metaplex-foundation/mpl-candy-machine-core/node_modules/@metaplex-foundation/beet/dist/types/src/types").ScalarFixedSizeBeet<T, V> | import("@metaplex-foundation/mpl-candy-machine-core/node_modules/@metaplex-foundation/beet/dist/types/src/types").ScalarFixedSizeBeet<T, Partial<T>>;
