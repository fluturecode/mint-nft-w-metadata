...
import { SolAmount } from '@metaplex-foundation/js/dist/types/types/Amount';
import { SolitaType } from '@metaplex-foundation/js/dist/types/types/Serializer';
...
export type MaybeAccount<T> = (Account<T> & {
...
export type AccountParsingAndAssertingFunction<T> = (unparsedAccount: UnparsedAccount | UnparsedMaybeAccount, solution?: string) => Account<T>;
