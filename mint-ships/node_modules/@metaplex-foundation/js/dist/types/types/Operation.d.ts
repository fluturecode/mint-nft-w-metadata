...
import { Signer } from '@metaplex-foundation/js/dist/types/types/Signer';
import { Program } from '@metaplex-foundation/js/dist/types/types/Program';
import { Metaplex } from '../Metaplex';
import { DisposableScope, RequiredKeys } from '@metaplex-foundation/js/dist/types/utils';
...
export type OperationConstructor<T extends Operation<K, I, O>, K extends string = KeyOfOperation<T>, I = InputOfOperation<T>, O = OutputOfOperation<T>> = {
    key: string;
    (input: I): T;
};
...
export type OperationScope = DisposableScope & RequiredKeys<OperationOptions, 'payer'>;
export type OperationHandler<T extends Operation<K, I, O>, K extends string = KeyOfOperation<T>, I = InputOfOperation<T>, O = OutputOfOperation<T>> = {
...
export declare const makeConfirmOptionsFinalizedOnMainnet: (metaplex: Metaplex, options?: ConfirmOptions) => ConfirmOptions | undefined;
