...
import { MetaplexFile, StorageDriver } from '@metaplex-foundation/js/dist/types/plugins/storageModule';
import { Metaplex } from '../../Metaplex';
import { Amount, IdentitySigner, KeypairSigner, Signer } from '@metaplex-foundation/js/dist/types/types';
...
export declare class BundlrStorageDriver implements StorageDriver {
    ...
    initNodeBundlr(address: string, currency: string, keypair: KeypairSigner, options: any): Promise<NodeBundlr>;
