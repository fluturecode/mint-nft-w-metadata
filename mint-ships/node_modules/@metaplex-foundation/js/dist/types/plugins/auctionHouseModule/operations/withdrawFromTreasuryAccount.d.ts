...
import { AuctionHouse } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models';
import type { Metaplex } from '../../../Metaplex';
import { Operation, OperationHandler, Signer, SolAmount, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const withdrawFromTreasuryAccountOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<WithdrawFromTreasuryAccountOperation, "WithdrawFromTreasuryAccountOperation", WithdrawFromTreasuryAccountInput, WithdrawFromTreasuryAccountOutput>;
/**
 * @group Operations
 * @category Types
 */
export type WithdrawFromTreasuryAccountOperation = Operation<typeof Key, WithdrawFromTreasuryAccountInput, WithdrawFromTreasuryAccountOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type WithdrawFromTreasuryAccountBuilderParams = Omit<WithdrawFromTreasuryAccountInput, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type WithdrawFromTreasuryAccountBuilderContext = Omit<WithdrawFromTreasuryAccountOutput, 'response'>;
/**
 * Transfers funds from Auction House Treasury Wallet to the Treasury Withdrawal Destination Wallet set on an Auction House creation.
 * By default Treasury Withdrawal Destination Wallet is set to `metaplex.identity()`.
 *
