...
import type { SendAndConfirmTransactionResponse } from '@metaplex-foundation/js/dist/types/plugins/rpcModule';
import { AuctionHouse, Listing } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models';
 ...
 */
export declare const createListingOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateListingOperation, "CreateListingOperation", CreateListingInput, CreateListingOutput>;
/**
 * @group Operations
 * @category Types
 */
