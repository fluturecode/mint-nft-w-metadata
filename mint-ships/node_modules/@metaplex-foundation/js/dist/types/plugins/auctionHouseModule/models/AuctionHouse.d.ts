...
import { AuctioneerAccount, AuctionHouseAccount } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/accounts';
import { Mint } from '@metaplex-foundation/js/dist/types/plugins/tokenModule';
import { Pda } from '@metaplex-foundation/js/dist/types/types';
...
/** @group Model Helpers */
export declare const toAuctionHouse: (auctionHouseAccount: AuctionHouseAccount, treasuryMint: Mint, auctioneerAccount?: AuctioneerAccount | null) => AuctionHouse;
