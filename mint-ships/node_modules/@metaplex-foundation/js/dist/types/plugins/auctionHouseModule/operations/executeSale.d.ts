...
import { AuctionHouse, Bid, Listing, Purchase } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models';
import { Option, TransactionBuilder, TransactionBuilderOptions } from '@metaplex-foundation/js/dist/types/utils';
import { Operation, OperationHandler, Pda, Signer, SolAmount, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const executeSaleOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<ExecuteSaleOperation, "ExecuteSaleOperation", ExecuteSaleInput, ExecuteSaleOutput>;
/**
 * @group Operations
 * @category Types
 */
export type ExecuteSaleOperation = Operation<typeof Key, ExecuteSaleInput, ExecuteSaleOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type ExecuteSaleBuilderParams = Omit<ExecuteSaleInput, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type ExecuteSaleBuilderContext = Omit<ExecuteSaleOutput, 'response' | 'purchase'>;
/**
 * @group Transaction Builders
 * @category Constructors
 */
