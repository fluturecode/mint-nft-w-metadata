 ...
 */
export declare const createBidOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateBidOperation, "CreateBidOperation", CreateBidInput, CreateBidOutput>;
/**
 * @group Operations
 * @category Types
 */
