...
import { Token } from '@metaplex-foundation/js/dist/types/plugins/tokenModule';
import { AuctionHouse, Listing, PrivateBid, PublicBid, Purchase } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models';
 ...
 */
export declare const directSellOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<DirectSellOperation, "DirectSellOperation", DirectSellInput, DirectSellOutput>;
/**
 * @group Operations
 * @category Types
 */
