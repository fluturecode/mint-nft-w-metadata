...
import { BidReceiptAccount } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/accounts';
import { Nft, NftWithToken, Sft, SftWithToken } from '@metaplex-foundation/js/dist/types/plugins/nftModule';
import { AuctionHouse } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models/AuctionHouse';
import { BigNumber, DateTime, Pda, SolAmount, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
...
export type LazyBid = Omit<Bid, 'lazy' | 'asset' | 'tokens'> & Readonly<{
    lazy: true;
