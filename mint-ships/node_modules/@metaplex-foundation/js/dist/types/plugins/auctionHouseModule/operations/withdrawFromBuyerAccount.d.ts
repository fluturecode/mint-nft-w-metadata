 ...
 */
export declare const withdrawFromBuyerAccountOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<WithdrawFromBuyerAccountOperation, "WithdrawFromBuyerAccountOperation", WithdrawFromBuyerAccountInput, WithdrawFromBuyerAccountOutput>;
/**
 * @group Operations
 * @category Types
 */
