...
import { AuctionHouse, Bid } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models';
 ...
 */
export declare const cancelBidOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CancelBidOperation, "CancelBidOperation", CancelBidInput, CancelBidOutput>;
/**
 * @group Operations
 * @category Types
 */
export type CancelBidOperation = Operation<typeof Key, CancelBidInput, CancelBidOutput>;
/**
 * @group Operations
 * @category Inputs
 */
