...
import { Operation, OperationHandler, SolAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const getBuyerBalanceOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<GetBuyerBalanceOperation, "GetBuyerBalanceOperation", GetBuyerBalanceInput, SolAmount>;
/**
 * @group Operations
 * @category Types
 */
export type GetBuyerBalanceOperation = Operation<typeof Key, GetBuyerBalanceInput, GetBuyerBalanceOutput>;
/**
 * @group Operations
 * @category Inputs
 */
