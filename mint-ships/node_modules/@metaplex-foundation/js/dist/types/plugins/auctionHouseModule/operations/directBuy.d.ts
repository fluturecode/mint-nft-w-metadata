 ...
 */
export declare const directBuyOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<DirectBuyOperation, "DirectBuyOperation", DirectBuyInput, DirectBuyOutput>;
/**
 * @group Operations
 * @category Types
 */
