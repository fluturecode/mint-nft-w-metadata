 ...
 */
export declare const findPurchaseByTradeStateOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FindPurchaseByTradeStateOperation, "FindPurchaseByTradeStateOperation", FindPurchaseByTradeStateInput, Readonly<{
    model: "purchase";
    lazy: false;
