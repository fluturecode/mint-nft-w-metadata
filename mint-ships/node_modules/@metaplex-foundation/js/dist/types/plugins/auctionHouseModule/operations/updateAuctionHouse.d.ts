 ...
 */
export declare const updateAuctionHouseOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UpdateAuctionHouseOperation, "UpdateAuctionHouseOperation", UpdateAuctionHouseInput, UpdateAuctionHouseOutput>;
/**
 * @group Operations
 * @category Types
 */
