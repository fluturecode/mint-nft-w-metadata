 ...
 */
export declare const depositToBuyerAccountOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<DepositToBuyerAccountOperation, "DepositToBuyerAccountOperation", DepositToBuyerAccountInput, DepositToBuyerAccountOutput>;
/**
 * @group Operations
 * @category Types
 */
export type DepositToBuyerAccountOperation = Operation<typeof Key, DepositToBuyerAccountInput, DepositToBuyerAccountOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type DepositToBuyerAccountBuilderParams = Omit<DepositToBuyerAccountInput, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type DepositToBuyerAccountBuilderContext = Omit<DepositToBuyerAccountOutput, 'response'>;
/**
 * Adds funds to the user's buyer escrow account for the given auction house.
 *
 * ```ts
