...
import { AuctionHouse, LazyListing, Listing } from '@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/models';
 ...
 */
export declare const findListingsOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FindListingsOperation, "FindListingsOperation", FindListingsInput, FindListingsOutput>;
/**
 * @group Operations
 * @category Types
 */
