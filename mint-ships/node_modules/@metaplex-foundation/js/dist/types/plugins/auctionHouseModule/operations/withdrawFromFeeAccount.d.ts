 ...
 */
export declare const withdrawFromFeeAccountOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<WithdrawFromFeeAccountOperation, "WithdrawFromFeeAccountOperation", WithdrawFromFeeAccountInput, WithdrawFromFeeAccountOutput>;
/**
 * @group Operations
 * @category Types
 */
export type WithdrawFromFeeAccountOperation = Operation<typeof Key, WithdrawFromFeeAccountInput, WithdrawFromFeeAccountOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type WithdrawFromFeeAccountBuilderParams = Omit<WithdrawFromFeeAccountInput, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type WithdrawFromFeeAccountBuilderContext = Omit<WithdrawFromFeeAccountOutput, 'response'>;
/**
 * Transfers funds from Auction House Fee Wallet to the Fee Withdrawal Destination Wallet.
 * By default Fee Withdrawal Destination Wallet is set to `metaplex.identity()`.
 *
