...
import { MintAccount } from '@metaplex-foundation/js/dist/types/plugins/tokenModule/accounts';
import { SplTokenCurrency, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
