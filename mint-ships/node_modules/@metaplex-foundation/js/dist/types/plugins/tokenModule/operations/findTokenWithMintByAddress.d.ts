 ...
 */
export declare const findTokenWithMintByAddressOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FindTokenWithMintByAddressOperation, "FindTokenWithMintByAddressOperation", FindTokenWithMintByAddressInput, TokenWithMint>;
/**
 * @group Operations
 * @category Types
 */
export type FindTokenWithMintByAddressOperation = Operation<typeof Key, FindTokenWithMintByAddressInput, TokenWithMint>;
/**
 * @group Operations
 * @category Inputs
 */
