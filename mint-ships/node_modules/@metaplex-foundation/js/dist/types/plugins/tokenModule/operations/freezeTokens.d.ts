 ...
 */
export declare const freezeTokensOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FreezeTokensOperation, "FreezeTokensOperation", FreezeTokensInput, FreezeTokensOutput>;
/**
 * @group Operations
 * @category Types
 */
