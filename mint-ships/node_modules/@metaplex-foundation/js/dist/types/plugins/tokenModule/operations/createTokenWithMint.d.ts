...
import { TokenWithMint } from '@metaplex-foundation/js/dist/types/plugins/tokenModule/models/Token';
 ...
 */
export declare const createTokenWithMintOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateTokenWithMintOperation, "CreateTokenWithMintOperation", CreateTokenWithMintInput, CreateTokenWithMintOutput>;
/**
 * @group Operations
 * @category Types
 */
