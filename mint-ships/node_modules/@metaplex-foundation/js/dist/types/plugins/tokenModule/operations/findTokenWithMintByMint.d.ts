 ...
 */
export declare const findTokenWithMintByMintOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FindTokenWithMintByMintOperation, "FindTokenWithMintByMintOperation", FindTokenWithMintByMintInput, TokenWithMint>;
/**
 * @group Operations
 * @category Types
 */
export type FindTokenWithMintByMintOperation = Operation<typeof Key, FindTokenWithMintByMintInput, TokenWithMint>;
/**
 * @group Operations
 * @category Inputs
 */
