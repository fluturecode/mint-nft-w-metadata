...
import { Mint } from '@metaplex-foundation/js/dist/types/plugins/tokenModule/models/Mint';
 ...
 */
export declare const createMintOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateMintOperation, "CreateMintOperation", CreateMintInput, CreateMintOutput>;
/**
 * @group Operations
 * @category Types
 */
export type CreateMintOperation = Operation<typeof Key, CreateMintInput, CreateMintOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type CreateMintBuilderParams = Omit<CreateMintInput, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type CreateMintBuilderContext = Omit<CreateMintOutput, 'response' | 'mint'>;
/**
 * Creates a new mint account.
 *
 * ```ts
