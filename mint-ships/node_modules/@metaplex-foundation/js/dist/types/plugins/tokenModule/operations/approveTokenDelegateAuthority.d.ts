...
import { KeypairSigner, Operation, OperationHandler, Signer, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const approveTokenDelegateAuthorityOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<ApproveTokenDelegateAuthorityOperation, "ApproveTokenDelegateAuthorityOperation", ApproveTokenDelegateAuthorityInput, ApproveTokenDelegateAuthorityOutput>;
/**
 * @group Operations
 * @category Types
 */
export type ApproveTokenDelegateAuthorityOperation = Operation<typeof Key, ApproveTokenDelegateAuthorityInput, ApproveTokenDelegateAuthorityOutput>;
/**
 * @group Operations
 * @category Inputs
 * */
 ...
 * @category Inputs
 */
export type ApproveTokenDelegateAuthorityBuilderParams = Omit<ApproveTokenDelegateAuthorityInput, 'confirmOptions'> & {
