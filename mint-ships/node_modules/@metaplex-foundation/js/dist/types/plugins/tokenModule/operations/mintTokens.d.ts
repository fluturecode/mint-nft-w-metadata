 ...
 */
export declare const mintTokensOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<MintTokensOperation, "MintTokensOperation", MintTokensInput, MintTokensOutput>;
/**
 * @group Operations
 * @category Types
 */
