...
import { Token } from '@metaplex-foundation/js/dist/types/plugins/tokenModule/models/Token';
 ...
 */
export declare const createTokenOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateTokenOperation, "CreateTokenOperation", CreateTokenInput, CreateTokenOutput>;
/**
 * @group Operations
 * @category Types
 */
