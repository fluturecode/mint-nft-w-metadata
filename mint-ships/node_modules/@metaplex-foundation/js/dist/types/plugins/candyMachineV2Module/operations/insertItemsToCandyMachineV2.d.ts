...
import { CandyMachineV2, CandyMachineV2Item } from '@metaplex-foundation/js/dist/types/plugins/candyMachineV2Module/models';
import { TransactionBuilder, TransactionBuilderOptions } from '@metaplex-foundation/js/dist/types/utils';
import { BigNumber, Operation, OperationHandler, Signer } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const insertItemsToCandyMachineV2Operation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<InsertItemsToCandyMachineV2Operation, "InsertItemsToCandyMachineV2Operation", InsertItemsToCandyMachineV2Input, InsertItemsToCandyMachineV2Output>;
/**
 * @group Operations
 * @category Types
 */
export type InsertItemsToCandyMachineV2Operation = Operation<typeof Key, InsertItemsToCandyMachineV2Input, InsertItemsToCandyMachineV2Output>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type InsertItemsToCandyMachineV2BuilderParams = Omit<InsertItemsToCandyMachineV2Input, 'confirmOptions'> & {
