 ...
 */
export declare const updateCandyMachineV2Operation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UpdateCandyMachineV2Operation, "UpdateCandyMachineV2Operation", UpdateCandyMachineV2Input, UpdateCandyMachineV2Output>;
/**
 * @group Operations
 * @category Types
 */
