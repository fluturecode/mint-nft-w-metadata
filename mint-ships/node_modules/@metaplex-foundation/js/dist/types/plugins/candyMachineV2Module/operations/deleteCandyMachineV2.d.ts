...
import { CandyMachineV2 } from '@metaplex-foundation/js/dist/types/plugins/candyMachineV2Module/models/CandyMachineV2';
 ...
 */
export declare const deleteCandyMachineV2Operation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<DeleteCandyMachineV2Operation, "DeleteCandyMachineV2Operation", DeleteCandyMachineV2Input, DeleteCandyMachineV2Output>;
/**
 * @group Operations
 * @category Types
 */
export type DeleteCandyMachineV2Operation = Operation<typeof Key, DeleteCandyMachineV2Input, DeleteCandyMachineV2Output>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type DeleteCandyMachineV2BuilderParams = Omit<DeleteCandyMachineV2Input, 'confirmOptions'> & {
