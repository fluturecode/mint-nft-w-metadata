 ...
 */
export declare const findCandyMachinesV2ByPublicKeyFieldOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FindCandyMachinesV2ByPublicKeyFieldOperation, "FindCandyMachinesV2ByPublicKeyOperation", FindCandyMachinesV2ByPublicKeyFieldInput, CandyMachineV2[]>;
/**
 * @group Operations
 * @category Types
 */
export type FindCandyMachinesV2ByPublicKeyFieldOperation = Operation<typeof Key, FindCandyMachinesV2ByPublicKeyFieldInput, CandyMachineV2[]>;
/**
 * @group Operations
 * @category Inputs
 */
