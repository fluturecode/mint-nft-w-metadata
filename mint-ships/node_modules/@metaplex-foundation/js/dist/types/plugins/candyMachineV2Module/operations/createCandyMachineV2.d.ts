...
import { SendAndConfirmTransactionResponse } from '@metaplex-foundation/js/dist/types/plugins/rpcModule';
import { CandyMachineV2, CandyMachineV2Configs } from '@metaplex-foundation/js/dist/types/plugins/candyMachineV2Module/models';
import { Option, RequiredKeys, TransactionBuilder, TransactionBuilderOptions } from '@metaplex-foundation/js/dist/types/utils';
import { Operation, OperationHandler, Signer } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const createCandyMachineV2Operation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateCandyMachineV2Operation, "CreateCandyMachineV2Operation", CreateCandyMachineV2Input, CreateCandyMachineV2Output>;
/**
 * @group Operations
 * @category Types
 */
export type CreateCandyMachineV2Operation = Operation<typeof Key, CreateCandyMachineV2Input, CreateCandyMachineV2Output>;
 ...
 * @category Inputs
 */
export type CreateCandyMachineV2Input = CreateCandyMachineV2InputWithoutConfigs & RequiredKeys<Partial<CandyMachineV2Configs>, 'price' | 'sellerFeeBasisPoints' | 'itemsAvailable'>;
/**
 * @group Operations
 * @category Outputs
 */
 ...
 * @category Inputs
 */
export type CreateCandyMachineV2BuilderParams = Omit<CreateCandyMachineV2Input, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type CreateCandyMachineV2BuilderContext = Omit<CreateCandyMachineV2Output, 'response' | 'candyMachine'>;
/**
 * Creates a brand new Candy Machine.
 *
 * ```ts
