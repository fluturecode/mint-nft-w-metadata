...
import { CandyGuardsSettings, DefaultCandyGuardSettings } from '@metaplex-foundation/js/dist/types/plugins/candyMachineModule/guards';
import { CandyGuard } from '@metaplex-foundation/js/dist/types/plugins/candyMachineModule/models/CandyGuard';
import { TransactionBuilder, TransactionBuilderOptions } from '@metaplex-foundation/js/dist/types/utils';
import { Operation, OperationHandler, Pda, Signer } from '@metaplex-foundation/js/dist/types/types';
 ...
 * @category Types
 */
export type CreateCandyGuardOperation<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = Operation<typeof Key, CreateCandyGuardInput<T>, CreateCandyGuardOutput<T>>;
/**
 * @group Operations
 * @category Inputs
 */
export type CreateCandyGuardInput<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = {
    /**
 ...
 * @category Outputs
 */
export type CreateCandyGuardOutput<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = {
 ...
 * @category Inputs
 */
export type CreateCandyGuardBuilderParams<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = Omit<CreateCandyGuardInput<T>, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type CreateCandyGuardBuilderContext = Omit<CreateCandyGuardOutput, 'response' | 'candyGuard'>;
/**
 * Creates a new Candy Guard account with the provided settings.
 *
 * ```ts
