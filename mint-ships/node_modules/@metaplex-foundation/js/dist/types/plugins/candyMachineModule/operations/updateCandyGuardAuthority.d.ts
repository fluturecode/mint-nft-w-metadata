 ...
 */
export declare const updateCandyGuardAuthorityOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UpdateCandyGuardAuthorityOperation, "UpdateCandyGuardAuthorityOperation", UpdateCandyGuardAuthorityInput, UpdateCandyGuardAuthorityOutput>;
/**
 * @group Operations
 * @category Types
 */
