 ...
 */
export declare const unwrapCandyGuardOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UnwrapCandyGuardOperation, "UnwrapCandyGuardOperation", UnwrapCandyGuardInput, UnwrapCandyGuardOutput>;
/**
 * @group Operations
 * @category Types
 */
