...
import { Operation, OperationHandler, PublicKey, Signer } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const deleteCandyGuardOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<DeleteCandyGuardOperation, "DeleteCandyGuardOperation", DeleteCandyGuardInput, DeleteCandyGuardOutput>;
/**
 * @group Operations
 * @category Types
 */
export type DeleteCandyGuardOperation = Operation<typeof Key, DeleteCandyGuardInput, DeleteCandyGuardOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type DeleteCandyGuardBuilderParams = Omit<DeleteCandyGuardInput, 'confirmOptions'> & {
