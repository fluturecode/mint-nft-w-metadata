 ...
 * @category Types
 */
export type UpdateCandyGuardOperation<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = Operation<typeof Key, UpdateCandyGuardInput<T>, UpdateCandyGuardOutput>;
/**
 * @group Operations
 * @category Inputs
 */
export type UpdateCandyGuardInput<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = {
 ...
 * @category Inputs
 */
export type UpdateCandyGuardBuilderParams<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = Omit<UpdateCandyGuardInput<T>, 'confirmOptions'> & {
