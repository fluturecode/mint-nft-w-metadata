...
import { CandyMachine, CandyMachineItem } from '@metaplex-foundation/js/dist/types/plugins/candyMachineModule/models';
 ...
 */
export declare const insertCandyMachineItemsOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<InsertCandyMachineItemsOperation, "InsertCandyMachineItemsOperation", InsertCandyMachineItemsInput, InsertCandyMachineItemsOutput>;
/**
 * @group Operations
 * @category Types
 */
