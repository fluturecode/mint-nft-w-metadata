...
import { CandyMachineItem } from '@metaplex-foundation/js/dist/types/plugins/candyMachineModule/models/CandyMachineItem';
import { CandyGuard } from '@metaplex-foundation/js/dist/types/plugins/candyMachineModule/models/CandyGuard';
import { AccountInfo, BigNumber, Creator, FeatureFlags, Model, PublicKey, UnparsedAccount } from '@metaplex-foundation/js/dist/types/types';
import { Option } from '@metaplex-foundation/js/dist/types/utils';
/**
 ...
 * @group Models
 */
export type CandyMachine<T extends CandyGuardsSettings = DefaultCandyGuardSettings> = Model<'candyMachine'> & {
...
export declare const getCandyMachineSize: (data: CandyMachineData) => number;
