 ...
 */
export declare const wrapCandyGuardOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<WrapCandyGuardOperation, "WrapCandyGuardOperation", WrapCandyGuardInput, WrapCandyGuardOutput>;
/**
 * @group Operations
 * @category Types
 */
export type WrapCandyGuardOperation = Operation<typeof Key, WrapCandyGuardInput, WrapCandyGuardOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type WrapCandyGuardBuilderParams = Omit<WrapCandyGuardInput, 'confirmOptions'> & {
