...
import { IdentitySigner, KeypairSigner, Signer, SolAmount } from '@metaplex-foundation/js/dist/types/types';
...
export declare class DerivedIdentityClient implements IdentitySigner, KeypairSigner {
    ...
    fund(amount: SolAmount): Promise<import("@metaplex-foundation/js/dist/types/plugins").TransferSolOutput>;
    withdraw(amount: SolAmount): Promise<import("@metaplex-foundation/js/dist/types/plugins").TransferSolOutput>;
    withdrawAll(): Promise<import("@metaplex-foundation/js/dist/types/plugins").TransferSolOutput>;
    close(): void;
