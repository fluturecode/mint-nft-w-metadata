import { CreateAccountInput, TransferSolInput } from '@metaplex-foundation/js/dist/types/plugins/systemModule/operations';
import { SystemBuildersClient } from '@metaplex-foundation/js/dist/types/plugins/systemModule/SystemBuildersClient';
...
export declare class SystemClient {
    ...
    createAccount(input: CreateAccountInput, options?: OperationOptions): Promise<import("@metaplex-foundation/js/dist/types/plugins/systemModule/operations").CreateAccountOutput>;
    /** {@inheritDoc transferSolOperation} */
    transferSol(input: TransferSolInput, options?: OperationOptions): Promise<import("@metaplex-foundation/js/dist/types/plugins/systemModule/operations").TransferSolOutput>;
}
