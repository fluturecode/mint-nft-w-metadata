...
import { Operation, OperationHandler, Signer, SolAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const createAccountOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateAccountOperation, "CreateAccountOperation", CreateAccountInput, CreateAccountOutput>;
/**
 * @group Operations
 * @category Types
 */
export type CreateAccountOperation = Operation<typeof Key, CreateAccountInput, CreateAccountOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type CreateAccountBuilderParams = Omit<CreateAccountInput, 'confirmOptions'> & {
