...
import { TokenMetadataAuthorityHolder, TokenMetadataAuthorityMetadata, TokenMetadataAuthorizationDetails } from '@metaplex-foundation/js/dist/types/plugins/nftModule/Authorization';
import { DelegateInputWithData } from '@metaplex-foundation/js/dist/types/plugins/nftModule/DelegateInput';
import { Sft } from '@metaplex-foundation/js/dist/types/plugins/nftModule/models';
 ...
 */
export declare const approveNftDelegateOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<ApproveNftDelegateOperation, "ApproveNftDelegateOperation", ApproveNftDelegateInput, ApproveNftDelegateOutput>;
/**
 * @group Operations
 * @category Types
 */
