...
import { TokenMetadataAuthorityTokenDelegate, TokenMetadataAuthorizationDetails } from '@metaplex-foundation/js/dist/types/plugins/nftModule/Authorization';
 ...
 */
export declare const unlockNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UnlockNftOperation, "UnlockNftOperation", UnlockNftInput, UnlockNftOutput>;
/**
 * @group Operations
 * @category Types
 */
