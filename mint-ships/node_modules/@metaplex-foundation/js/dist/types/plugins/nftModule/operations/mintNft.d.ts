...
import { TokenMetadataAuthorityMetadata, TokenMetadataAuthorizationDetails } from '@metaplex-foundation/js/dist/types/plugins/nftModule/Authorization';
 ...
 */
export declare const mintNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<MintNftOperation, "MintNftOperation", MintNftInput, MintNftOutput>;
/**
 * @group Operations
 * @category Types
 */
