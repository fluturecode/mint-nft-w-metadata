...
import { TokenMetadataAuthorityHolder, TokenMetadataAuthorityTokenDelegate } from '@metaplex-foundation/js/dist/types/plugins/nftModule/Authorization';
import { TransactionBuilder, TransactionBuilderOptions } from '@metaplex-foundation/js/dist/types/utils';
import { Operation, OperationHandler, Signer, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const deleteNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<DeleteNftOperation, "DeleteNftOperation", DeleteNftInput, DeleteNftOutput>;
/**
 * @group Operations
 * @category Types
 */
export type DeleteNftOperation = Operation<typeof Key, DeleteNftInput, DeleteNftOutput>;
/**
 * @group Operations
 * @category Inputs
 */
