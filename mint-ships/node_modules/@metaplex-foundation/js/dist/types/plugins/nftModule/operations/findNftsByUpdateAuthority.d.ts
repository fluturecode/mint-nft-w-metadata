...
import { Metadata, Nft, Sft } from '@metaplex-foundation/js/dist/types/plugins/nftModule/models';
 ...
 */
export declare const findNftsByUpdateAuthorityOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<FindNftsByUpdateAuthorityOperation, "FindNftsByUpdateAuthorityOperation", FindNftsByUpdateAuthorityInput, FindNftsByUpdateAuthorityOutput>;
/**
 * @group Operations
 * @category Types
 */
export type FindNftsByUpdateAuthorityOperation = Operation<typeof Key, FindNftsByUpdateAuthorityInput, FindNftsByUpdateAuthorityOutput>;
/**
 * @group Operations
 * @category Inputs
 */
