...
import { BigNumber, CreatorInput, Operation, OperationHandler, Signer } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const createNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateNftOperation, "CreateNftOperation", CreateNftInput, CreateNftOutput>;
/**
 * @group Operations
 * @category Types
 */
