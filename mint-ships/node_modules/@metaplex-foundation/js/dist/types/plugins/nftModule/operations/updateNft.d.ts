...
import { TokenMetadataAuthority, TokenMetadataAuthorizationDetails } from '@metaplex-foundation/js/dist/types/plugins/nftModule/Authorization';
...
import { CreatorInput, Operation, OperationHandler, Signer } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const updateNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UpdateNftOperation, "UpdateNftOperation", UpdateNftInput, UpdateNftOutput>;
/**
 * @group Operations
 * @category Types
 */
