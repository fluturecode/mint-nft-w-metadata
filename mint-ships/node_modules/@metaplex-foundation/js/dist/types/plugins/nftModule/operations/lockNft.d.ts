 ...
 */
export declare const lockNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<LockNftOperation, "LockNftOperation", LockNftInput, LockNftOutput>;
/**
 * @group Operations
 * @category Types
 */
