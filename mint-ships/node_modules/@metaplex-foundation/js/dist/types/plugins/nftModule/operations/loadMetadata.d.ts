...
import { Metadata, Nft, NftWithToken, Sft, SftWithToken } from '@metaplex-foundation/js/dist/types/plugins/nftModule/models';
 ...
 */
export declare const loadMetadataOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<LoadMetadataOperation, "LoadMetadataOperation", LoadMetadataInput, Sft | SftWithToken | Nft | NftWithToken>;
/**
 * @group Operations
 * @category Types
 */
export type LoadMetadataOperation = Operation<typeof Key, LoadMetadataInput, LoadMetadataOutput>;
/**
 * @group Operations
 * @category Inputs
 */
