...
import { Sft, SftWithToken } from '@metaplex-foundation/js/dist/types/plugins/nftModule/models';
import { Option, TransactionBuilder, TransactionBuilderOptions } from '@metaplex-foundation/js/dist/types/utils';
import { BigNumber, CreatorInput, Operation, OperationHandler, Signer, SplTokenAmount } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const createSftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateSftOperation, "CreateSftOperation", CreateSftInput, CreateSftOutput>;
/**
 * @group Operations
 * @category Types
 */
