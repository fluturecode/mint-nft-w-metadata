...
import { Nft } from '@metaplex-foundation/js/dist/types/plugins/nftModule/models';
 ...
 */
export declare const createCompressedNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<CreateCompressedNftOperation, "CreateCompressedNftOperation", CreateCompressedNftInput, CreateCompressedNftOutput>;
/**
 * @group Operations
 * @category Types
 */
