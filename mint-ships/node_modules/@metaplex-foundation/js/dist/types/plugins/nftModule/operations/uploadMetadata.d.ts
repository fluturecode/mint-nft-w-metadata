import { MetaplexFile } from '@metaplex-foundation/js/dist/types/plugins/storageModule';
import { JsonMetadata } from '@metaplex-foundation/js/dist/types/plugins/nftModule/models';
 ...
 */
export declare const uploadMetadataOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<UploadMetadataOperation, "UploadMetadataOperation", UploadMetadataInput, UploadMetadataOutput>;
/**
 * @group Operations
 * @category Types
 */
