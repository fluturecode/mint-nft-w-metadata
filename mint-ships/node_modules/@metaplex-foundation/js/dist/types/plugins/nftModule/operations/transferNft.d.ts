 ...
 */
export declare const transferNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<TransferNftOperation, "TransferNftOperation", TransferNftInput, TransferNftOutput>;
/**
 * @group Operations
 * @category Types
 */
