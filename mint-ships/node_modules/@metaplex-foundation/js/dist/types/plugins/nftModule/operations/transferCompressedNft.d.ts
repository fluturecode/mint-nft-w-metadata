...
import { TokenMetadataAuthorityHolder, TokenMetadataAuthorityTokenDelegate, TokenMetadataAuthorizationDetails } from '@metaplex-foundation/js/dist/types/plugins/nftModule/Authorization';
...
import { Operation, OperationHandler, Signer, SplTokenAmount, TransferNftCompressionParam } from '@metaplex-foundation/js/dist/types/types';
 ...
 */
export declare const transferCompressedNftOperation: import("@metaplex-foundation/js/dist/types/types").OperationConstructor<TransferCompressedNftOperation, "TransferCompressedNftOperation", TransferCompressedNftInput, TransferCompressedNftOutput>;
/**
 * @group Operations
 * @category Types
 */
